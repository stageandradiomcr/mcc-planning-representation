...
${formattedDate}`;
    ...
    const mailto = `mailto:${councilEmail}?cc=${encodeURIComponent("advancing@stageandradio.co.uk")}&subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBodyWithoutSignature)}`;
